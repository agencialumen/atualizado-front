...
export default function QuizQuestion7() {
  ...
  const [points, setPoints] = useState(300) // Pontos acumulados
  ...
  const handleOptionSelect = (optionId: string) => {
    ...
    setTimeout(() => {
      ...
      if (selectedOptionData?.isCorrect) {
        ...
        // Ir para resultado após 2 segundos
        setTimeout(() => {
      ...
      <div className="flex flex-col flex-1 p-4">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-[#bae3e3] rounded-3xl p-6 shadow-lg border-2 border-[#00E0FF] relative">
            ...
            {/* Motivation Footer */}
            <div className="mt-6 bg-gradient-to-r from-orange-100 to-red-100 rounded-xl p-3">
              <div className="text-center text-[#008080] text-sm font-semibold">
                🚀 ÚLTIMA PERGUNTA! Prepare-se para trocar seus pontos por prêmios incríveis!
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 flex justify-center">
            <div className="flex space-x-1">
              ...
              <div className="w-3 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-3 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-3 h-2 bg-[#00a9a4] rounded-full animate-pulse"></div>
            </div>
          </div>
        </div>
