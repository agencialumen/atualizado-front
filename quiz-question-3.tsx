...
const quizOptions: QuizOption[] = [
  { id: "1", text: "Toalha de rosto", isCorrect: false },
  { id: "2", text: "Lenços umedecidos pampers", isCorrect: true },
  { id: "3", text: "Algodão seco", isCorrect: false },
  { id: "4", text: "Papel higiênico", isCorrect: false },
]
...
export default function QuizQuestion3() {
  ...
  const [points, setPoints] = useState(100) // Pontos acumulados
          ...
          <div className="bg-[#bae3e3] rounded-3xl p-6 shadow-lg border-2 border-[#00E0FF] relative">
            ...
            <div className="mb-6 mt-4">
              ...
              <h2 className="text-[#008080] text-lg font-semibold mb-4">
                3. Qual destes produtos Pampers é ideal para limpeza suave da pele do bebê?
              </h2>
            </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-3">
              <div className="text-center text-[#008080] text-sm font-semibold">
                🔥 Você está na metade! Mais 4 perguntas para trocar seus pontos!
              </div>
            </div>
          </div>
