...
const quizOptions: QuizOption[] = [
  { id: "1", text: "Cheiro forte e marcante", isCorrect: false },
  { id: "2", text: "Possui luz noturna embutida", isCorrect: false },
  { id: "3", text: "Barreiras antivazamento e toque suave", isCorrect: true },
  { id: "4", text: "Tem bolso lateral para brinco", isCorrect: false },
]
...
export default function QuizQuestion6() {
  ...
  const [points, setPoints] = useState(250) // Pontos acumulados
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-[#bae3e3] rounded-3xl p-6 shadow-lg border-2 border-[#00E0FF] relative">
            ...
            <div className="mb-6 mt-4">
              ...
              <h2 className="text-[#008080] text-lg font-semibold mb-4">
                6. O que torna a fralda Pampers Confort Sec especial para o bebê?
              </h2>
            </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-3">
              <div className="text-center text-[#008080] text-sm font-semibold">
                🎉 Última pergunta! Troque seus pontos na próxima tela!
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 flex justify-center">
            <div className="flex space-x-2">
              ...
              <div className="w-4 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-4 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-4 h-2 bg-[#00a9a4] rounded-full animate-pulse"></div>
              <div className="w-4 h-2 bg-gray-300 rounded-full"></div>
            </div>
          </div>
        </div>
