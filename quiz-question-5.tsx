...
const quizOptions: QuizOption[] = [
  { id: "1", text: "A fralda muda de cor completamente", isCorrect: false },
  { id: "2", text: "A linha indicadora de umidade muda de cor", isCorrect: true },
  { id: "3", text: "O bebê começa a chorar", isCorrect: false },
  { id: "4", text: "A fralda começa a cair", isCorrect: false },
]

export default function QuizQuestion5() {
  const [selectedOption, setSelectedOption] = useState<string | null>(null)
  const [showResult, setShowResult] = useState(false)
  const [showCelebration, setShowCelebration] = useState(false)
  const [points, setPoints] = useState(200) // Pontos acumulados
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-[#bae3e3] rounded-3xl p-6 shadow-lg border-2 border-[#00E0FF] relative">
            ...
            <div className="mb-6 mt-4">
              ...
              <h2 className="text-[#008080] text-lg font-semibold mb-4">
                5. Qual é o sinal de que está na hora de trocar a fralda Pampers?
              </h2>
            </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-3">
              <div className="text-center text-[#008080] text-sm font-semibold">
                ⭐ Quase terminando! Mais 2 perguntas para trocar seus pontos!
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 flex justify-center">
            <div className="flex space-x-2">
              <div className="w-5 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-5 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-5 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-5 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-5 h-2 bg-[#00a9a4] rounded-full animate-pulse"></div>
              <div className="w-5 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-5 h-2 bg-gray-300 rounded-full"></div>
            </div>
          </div>
