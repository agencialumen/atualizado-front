...
const quizOptions: QuizOption[] = [
  { id: "1", text: "Passar talco em excesso", isCorrect: false },
  { id: "2", text: "Trocar a fralda só à noite", isCorrect: false },
  { id: "3", text: "Manter a pele limpinha e seca com fraldas respiráveis", isCorrect: true },
  { id: "4", text: "Colar com duas fraldas", isCorrect: false },
]
...
export default function QuizQuestion2() {
  ...
  const [points, setPoints] = useState(50) // Pontos da pergunta anterior
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-[#bae3e3] rounded-3xl p-6 shadow-lg border-2 border-[#00E0FF] relative">
            ...
            <div className="mb-6 mt-4">
              ...
              <h2 className="text-[#008080] text-lg font-semibold mb-4">
                2. O que ajuda a evitar assaduras na pele do bebê?
              </h2>
            </div>
              ...
              {quizOptions.map((option) => (
                ...
                >
                  ...
                  {showResult && selectedOption === option.id && option.isCorrect && (
                    <span className="ml-2 flex-shrink-0 animate-pulse">✓ +50 pontos!</span>
                  )}
                </Button>
              ))}
            </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-3">
              <div className="text-center text-[#008080] text-sm font-semibold">
                🎯 Você está indo muito bem! Mais 5 perguntas para trocar seus pontos!
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 flex justify-center">
            <div className="flex space-x-2">
              ...
              <div className="w-8 h-2 bg-[#00a9a4] rounded-full animate-pulse"></div>
              <div className="w-8 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-8 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-8 h-2 bg-gray-300 rounded-full"></div>
              <div className="w-8 h-2 bg-gray-300 rounded-full"></div>
