...
const quizOptions: QuizOption[] = [
  { id: "1", text: "Alta durabilidade", isCorrect: false },
  { id: "2", text: "Preço mais baixo", isCorrect: false },
  { id: "3", text: "Mantém o bebê sequinho por até 12h", isCorrect: true },
  { id: "4", text: "Estilo moderno", isCorrect: false },
]
          ...
          <div className="bg-[#bae3e3] rounded-3xl p-6 shadow-lg border-2 border-[#00E0FF] relative">
            ...
            <div className="mb-6 mt-4">
              ...
              <h2 className="text-[#008080] text-lg font-semibold mb-4">
                1. Qual é o principal benefício das fraldas Pampers?
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {quizOptions.map((option) => (
                <Button
                  ...
                  disabled={showResult}
                  className={`
                    w-full p-4 text-left rounded-xl text-white font-medium transition-all duration-300
                    ${
                ...
                >
                  ...
                  {showResult && selectedOption === option.id && option.isCorrect && (
                    <span className="ml-2 animate-pulse">✓ +50 pontos!</span>
                  )}
                </Button>
              ))}
            </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-3">
              <div className="text-center text-[#008080] text-sm font-semibold">
                🎯 Continue acertando para acumular mais pontos!
              </div>
            </div>
          </div>
